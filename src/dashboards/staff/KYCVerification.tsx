    ...
    if (rejectingUser && rejectionReason) {
      try {
        await rejectKYC({
          ...
          rejectionReason,
          rejectedBy: currentUser?.name || 'Staff',
        }).unwrap();
            ...
            <div className="space-y-6">
              <Tabs defaultValue="personal" className="w-full">
                ...
                <TabsContent value="bank" className="space-y-4">
                  <p className="text-sm text-muted-foreground">Bank details not available in KYC submission</p>
                </TabsContent>
                <TabsContent value="address" className="space-y-4">
                  <p className="text-sm text-muted-foreground">Address details not available in KYC submission</p>
                </TabsContent>
              </Tabs>
            </div>
          )}
