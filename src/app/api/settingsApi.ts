...
export interface SystemSettings {
    ...
    max_earnings_before_active_buyer: number; // Maximum number of binary pairs non-Active Buyer distributors can earn commission for before becoming Active Buyer (default: 5 pairs). 6th+ pairs are blocked until user becomes Active Buyer (default: 5, min: 1)
