...
- **Access Token**: 60 minutes (1 hour) (Backend Customizable)
- **Refresh Token**: 1440 minutes (24 hours)(Backend Customizable)
...
**Frontend Action**: Store both tokens securely (localStorage).
